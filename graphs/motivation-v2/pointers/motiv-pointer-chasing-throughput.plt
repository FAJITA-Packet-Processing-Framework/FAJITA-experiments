...
llc_file = "csvs/NFLLCMISSESPP.csv"
y_scale=1
...
set terminal pdf color enhanced font "Helvetica,35" size 10cm,5cm;
...
# Y2-axis
set y2label "LLC Misses / packet" font "Helvetica-Bold,16"
...
plot baseline_file using ($1):($5/1000000):($4/1000000):($6/1000000) with errorbars ls 1 title "Throughput",\
     baseline_file using ($1):($5/1000000) with lines ls 1 dt 2 notitle,\
