...
### Input files
input_file_4_ways  = "csvs-4way/OFRXPPS.csv"
input_file_8_ways  = "csvs-8way/OFRXPPS.csv"
input_file_12_ways  = "csvs-12way/OFRXPPS.csv"
...
plot \
        input_file_12_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 1 title "12-way LLC",\
        input_file_12_ways  using ($1*24/1000):($5) with lines ls 1 dt 5 notitle,\
        input_file_8_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 2 title "8-way LLC",\
        input_file_8_ways  using ($1*24/1000):($5) with lines ls 2 dt 5 notitle,\
        input_file_4_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 3 title "4-way LLC",\
        input_file_4_ways  using ($1*24/1000):($5) with lines ls 3 dt 5 notitle
unset multiplot
