...
### Input files
input_file_4_ways  = "csvs-4way/LLC-MISSES-PP.csv"
input_file_8_ways  = "csvs-8way/LLC-MISSES-PP.csv"
input_file_12_ways  = "csvs-12way/LLC-MISSES-PP.csv"
...
plot \
        input_file_12_ways  using ($1*24/1000):($5 * 8):($3 * 8):($7 * 8) with errorbars ls 1 title "12-way LLC",\
        input_file_12_ways  using ($1*24/1000):($5 * 8) with lines ls 1 dt 5 notitle,\
        input_file_8_ways  using ($1*24/1000):($5 * 8):($3 * 8):($7 * 8) with errorbars ls 2 title "8-way LLC",\
        input_file_8_ways  using ($1*24/1000):($5 * 8) with lines ls 2 dt 5 notitle,\
        input_file_4_ways  using ($1*24/1000):($5 * 8):($3 * 8):($7 * 8) with errorbars ls 3 title "4-way LLC",\
        input_file_4_ways  using ($1*24/1000):($5 * 8) with lines ls 3 dt 5 notitle
unset multiplot
