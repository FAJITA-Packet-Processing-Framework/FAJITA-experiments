...
### Input files
input_file_4_ways  = "1core-4ways/OFRXPPS.csv"
input_file_8_ways  = "1core-8ways/OFRXPPS.csv"
input_file_11_ways  = "1core-12ways/Vanilla-FastclickOFRXPPS.csv"
...
# Y-axis
set ylabel "{/Helvetica:Bold Output Packet Rate (Mpps)}"
...
plot \
        input_file_11_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 4 title "12-way LLC",\
        input_file_11_ways  using ($1*24/1000):($5) with lines ls 4 dt 5 notitle,\
        input_file_8_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 3 title "8-way LLC",\
        input_file_8_ways  using ($1*24/1000):($5) with lines ls 3 dt 5 notitle,\
        input_file_4_ways  using ($1*24/1000):($5):($4):($6) with errorbars ls 2 title "4-way LLC",\
