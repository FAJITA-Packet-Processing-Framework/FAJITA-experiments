...
set output "eval-throughput-flows-var-square.pdf"
...
fastclick_file = "csvs/fastclickOFRXPPS.csv"
...
plot \
        fajita_file using ($1*64/1000):($5/1000000):($4/1000000):($6/1000000) with errorbars ls 1 title "FAJITA",\
        fajita_file using ($1*64/1000):($5/1000000) with lines ls 1 dt 5 notitle,\
        fastclick_file using ($1*64/1000):($5/1000000):($4/1000000):($6/1000000) with errorbars ls 4 title "FastClick+BR",\
        fastclick_file using ($1*64/1000):($5/1000000) with lines ls 4 dt 5 notitle
unset multiplot
