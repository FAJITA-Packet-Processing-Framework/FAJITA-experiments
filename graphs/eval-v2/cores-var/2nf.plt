...
### Input file
fc_file = "csvs/fcbr-twoOFRXPPS.csv"
fajita_file = "csvs/fajita-twoOFRXPPS.csv"
vpp_file="csvs/vpp-twoOFRXPPS.csv"
y_scale=1
...
set output 'throughput-2nfs.svg'
