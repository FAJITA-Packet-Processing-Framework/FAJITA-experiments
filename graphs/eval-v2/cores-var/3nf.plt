...
### Input file
fc_file = "csvs/fcbr-threeOFRXPPS.csv"
fajita_file = "csvs/fajita-threeOFRXPPS.csv"
vpp_file="csvs/vpp-threeOFRXPPS.csv"
y_scale=1
...
set output 'throughput-3nfs.svg'
...
set arrow nohead back dashtype 2 from -0.5,178 to 4.3,178 linewidth 3
