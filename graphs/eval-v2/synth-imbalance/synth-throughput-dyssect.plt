...
set output "throughput-imbalance-synthetic-dyssect.pdf"
...
plot \
     input_file using 1:5 with lines ls 1 dt 5 notitle, \
     input_file using 1:5 with errorbars ls 1 title 'Dyssect', \
     input_file using 1:4 with lines ls 3 dt 5 notitle, \
     input_file using 1:4 with errorbars ls 3 title 'FAJITA'
