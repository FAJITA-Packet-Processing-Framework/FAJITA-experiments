...
### Input files
input_file_1 = "shaped-csvs/fajitaDROPRATE.csv"
input_file_2  = "shaped-csvs/solver-dyssectDROPRATE.csv"
input_file_3  = "shaped-csvs/nosolver-dyssectDROPRATE.csv"
...
# Y-axis
set ylabel "{/Helvetica:Bold Drop Rate (\%)}"
...
plot \
	input_file_1  using ($1):($9*100):(($3)*100):(($7)*100) with errorbars ls 1 title "FAJITA",\
	input_file_3  using ($1):(($9)*100):(($3)*100):(($7)*100) with errorbars ls 2 title "Dyssect - w/o LB",\
        input_file_2  using ($1):(($9)*100):(($3)*100):(($7)*100) with errorbars ls 4 title "Dyssect",\
	input_file_1  using ($1):(($9)*100) with lines ls 1 dt 5 notitle,\
        input_file_3  using ($1):(($9)*100) with lines ls 2 dt 2 notitle,\
	input_file_2  using ($1):(($9)*100) with lines ls 4 dt 4 notitle
