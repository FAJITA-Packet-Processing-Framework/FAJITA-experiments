...
plot baseline_file using ($2/1000000):xtic(1) ls 1 title "w/o per NF prefetching", \
     '' using (($3-$2)/1000000) ls 2 title "w/ per NF prefetching", \
     '' using 1:(($3/1000000)+7):(sprintf("%.2f\%", $4)) with labels font "Helvetica,12" notitle
