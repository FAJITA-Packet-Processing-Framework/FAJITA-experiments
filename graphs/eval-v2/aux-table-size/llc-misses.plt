...
set output "eval-llc-misses.pdf"
...
### Input files
input_file_1 = "csvs-flows-var/noaux-fajitaNFLLCMISSESPP.csv"
input_file_2  = "csvs-flows-var/aux-fajitaNFLLCMISSESPP.csv"
...
plot \
	input_file_1  using ($1*0.064):($9*8):(($3)*8):(($7)*8) with errorbars ls 1 title "FAJITA w/o auxiliary HT",\
        input_file_2  using ($1*0.064):(($9)*8):(($3)*8):(($7)*8) with errorbars ls 4 title "FAJITA w/ auxiliary HT",\
	input_file_1  using ($1*0.064):(($9)*8) with lines ls 1 dt 5 notitle,\
	input_file_2  using ($1*0.064):(($9)*8) with lines ls 4 dt 4 notitle
