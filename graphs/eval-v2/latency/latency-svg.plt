...
### Input files
fc_file = "csvs/fastclickLATENCY.csv"
fajita_file  = "csvs/fajitaLATENCY.csv"
vpp_file = "csvs/vppLATENCY.csv"
...
# Y-axis
set ylabel "{/Helvetica:Bold Average Latency (μs)}"
set ylabel offset 2.2,0
