...
### Input file
file0 = "csvs-with-vpp/vppOFRXPPS.csv"
file1 = "csvs-with-vpp/fcbrOFRXPPS.csv"
file2 = "csvs-with-vpp/noaux-fajitaOFRXPPS.csv"
file3 = "csvs-with-vpp/aux-fajitaOFRXPPS.csv"
...
# Plot FastClick
plot file0 using ($5/1000000):xtic(1) ls 3 title "VPP", \
     file1 using ($5/1000000) with histogram ls 4 title "FastClick+BR", \
