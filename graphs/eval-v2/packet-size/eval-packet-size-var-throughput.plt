...
### Input file
fc_file = "csvs-4cores/fcbrOFRXPPS.csv"
fajita_file = "csvs-4cores/fajitaOFRXPPS.csv"
vpp_file = "csvs-4cores/vppOFRXPPS.csv"
y_scale=1
...
set output 'packet-size-var-throughput.pdf'
...
plot fc_file using ($9 * ($1 + 24) * 8 / 1000000000):xtic(1) ls 4 title "FastClick+BR", \
vpp_file using ($9 * ($1 + 24) * 8 / 1000000000) with histogram ls 2 title "VPP", \
fajita_file using ($9 * ($1 + 24) * 8 / 1000000000) with histogram ls 1 title "FAJITA"
