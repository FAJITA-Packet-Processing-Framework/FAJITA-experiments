...
### Input file
baseline_file = "data-shared-16cores.dat"
...
set arrow from 4.5,0 to 4.5,210 ls 1 linewidth 2 dashtype 2 nohead
set label 'shared-nothing' at 0.75,170 font "Helvetica-Bold,16"
set label 'shared' at 5.4,170 font "Helvetica-Bold,16"
set object 1 rectangle from 4.5, graph 0 to 7.5, graph 1 behind fillcolor rgb '#e5f5e0' fillstyle solid noborder

plot baseline_file using 1:3:($3>85 ? 0x005a32 : $3> 71 ? 0X238443 : $3> 70 ? 0x41ab5d : $3 > 61 ? 0x78c679 : $3 > 60 ? 0X238443 : $3> 15 ? 0x78c679 : 0xaddd8e):xticlabels(2) with boxes ls 1 lc rgb var notitle, \
