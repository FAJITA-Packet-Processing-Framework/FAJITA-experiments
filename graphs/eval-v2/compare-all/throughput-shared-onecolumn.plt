...
set terminal pdf color enhanced font "Helvetica,35" size 12cm,4.5cm;
...
set label 'shared-nothing' at 0.75,100 font "Helvetica-Bold,16"
set label 'shared' at 5.4,100 font "Helvetica-Bold,16"
set object 1 rectangle from 4.5, graph 0 to 7.5, graph 1 behind fillcolor rgb '#e5f5e0' fillstyle solid noborder

plot baseline_file using 1:3:($3>60 ? 0x005a32 : $3> 45 ? 0X238443 : $3> 42 ? 0x41ab5d : $3 > 20 ? 0X238443 : $3> 15 ? 0x78c679 : 0xaddd8e):xticlabels(2) with boxes ls 1 lc rgb var notitle, \
