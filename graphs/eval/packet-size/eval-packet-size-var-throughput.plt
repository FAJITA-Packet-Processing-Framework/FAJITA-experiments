...
# X-axis
set xlabel "Packet size (B)" font "Helvetica-Bold,23"
...
# Y-axis
set ylabel "Throughput (Gbps)" font "Helvetica-Bold,23"
...
ref_file using ($6 * $2 * 0.008) with histogram ls 3 title "FAJITA"
