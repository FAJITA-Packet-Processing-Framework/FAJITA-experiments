...
plot \
        input_file_12_ways  using ($1*24/1000):($5 * 8):($3 * 8):($7 * 8) with errorbars ls 4 title "FAJITA",\
        input_file_12_ways  using ($1*24/1000):($5 * 8) with lines ls 4 dt 5 notitle,\
        input_file_4_ways  using ($1*24/1000):($5 * 8):($3 * 8):($7 * 8) with errorbars ls 1 title "FastClick+BR",\
        input_file_4_ways  using ($1*24/1000):($5 * 8) with lines ls 1 dt 5 notitle
unset multiplot
