...
### Input files
input_file_1 = "campus-imbalance.csv"
...
plot \
	input_file_1  using ($1/500):($9-100):(($4)-100):(($6)-100) with errorbars ls 1 title "Campus",\
	input_file_2  using ($1/1000):(($9)-100):(($4)-100):(($6)-100) with errorbars ls 4 title "CAIDA",\
        input_file_1  using ($1/500):(($9)-100) with lines ls 1 dt 5 notitle,\
	input_file_2  using ($1/1000):(($9)-100) with lines ls 4 dt 4 notitle
unset multiplot
