...
### Input files
input_file_1_way = "vanillafc-throughput.csv"
input_file_2_ways  = "fajita-throughput.csv"
...
plot \
	input_file_2_ways  using ($1/250000):($5):($3):($7) with errorbars ls 3 title "FAJITA",\
        input_file_2_ways  using ($1/250000):($5) with lines ls 3 dt 5 notitle,\
        input_file_1_way  using ($1/250000):($5):($3):($7) with errorbars ls 4 title "Vanilla-FastClick",\
